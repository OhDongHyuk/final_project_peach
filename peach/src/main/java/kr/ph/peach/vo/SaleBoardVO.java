...
public class SaleBoardVO {
	...
	/*
	 * public SaleBoardVO(String sb_name, int sb_price, String sb_info, int
	 * sb_sc_num) { this.sb_name = sb_name; this.sb_price = sb_price; this.sb_info =
	 * sb_info; this.sb_sc_num = sb_sc_num; }
	 */
